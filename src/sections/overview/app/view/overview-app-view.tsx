...
import AlertsList from '../../e-commerce/alerts-and-notifications';
    ...
    clients: [
      {
        ...
        day: {
          ...
          costs: {
            totalCost: 11394,
            costBySource: { 'Solar Energy': 0, '(WAPDA) - Electricity': 14078, Generator: 2192 },
        ...
        month: {
          totalConsumption: {
            ...
            percentChange: 1.16,
            chartData: [
              874, 679, 746, 515, 790, 970, 809, 914, 707, 969, 622, 867, 891, 775, 850, 689, 881,
              809, 668, 687, 716, 910, 733, 980, 888, 997, 828, 840, 503, 984,
            ],
          },
          currentUsage: {
            value: 607,
            percentChange: -4.35,
            chartData: [
              622, 793, 608, 664, 602, 763, 615, 711, 685, 628, 613, 608, 622, 788, 711, 786, 670,
              661, 768, 758, 742, 716, 702, 769, 767, 666, 787, 750, 639, 745,
            ],
          },
          energyBySource: [
            { label: 'Solar Energy', value: 21 },
          ...
          costs: {
            totalCost: 247226,
            costBySource: { 'Solar Energy': 0, '(WAPDA) - Electricity': 143666, Generator: 43220 },
        ...
        year: {
          totalConsumption: {
            ...
            percentChange: 14.32,
            chartData: [
              17397, 20034, 17911, 21458, 23738, 23396, 21410, 17830, 23039, 21849, 22557, 24997,
            ],
          },
          currentUsage: {
            value: 15540,
            percentChange: -0.79,
            chartData: [
              23941, 15575, 16967, 17453, 15506, 16816, 20893, 15655, 19822, 15083, 18889, 23910,
            ],
          },
          energyBySource: [
            { label: 'Solar Energy', value: 24 },
          ...
          costs: {
            ...
            averageCostPerKWh: { '(WAPDA) - Electricity': 33.9, Generator: 49.75 },
          },
        },
      },
      {
        ...
        day: {
          ...
          costs: {
            totalCost: 13069,
            costBySource: { 'Solar Energy': 0, '(WAPDA) - Electricity': 6934, Generator: 4990 },
        ...
        month: {
          totalConsumption: {
            ...
            percentChange: 5.66,
            chartData: [
              931, 606, 986, 941, 587, 960, 833, 620, 966, 635, 873, 635, 850, 665, 773, 811, 838,
              714, 687, 528, 770, 702, 629, 760, 914, 910, 982, 530, 727, 983,
            ],
          },
          currentUsage: {
            value: 732,
            percentChange: -4.79,
            chartData: [
              676, 637, 608, 767, 798, 762, 708, 752, 742, 707, 610, 633, 677, 669, 713, 685, 760,
              738, 726, 749, 771, 702, 606, 614, 668, 679, 641, 793, 670, 776,
            ],
          },
          energyBySource: [
            { label: 'Solar Energy', value: 23 },
          ...
          costs: {
            totalCost: 154414,
            costBySource: { 'Solar Energy': 0, '(WAPDA) - Electricity': 186050, Generator: 44056 },
        ...
        year: {
          totalConsumption: {
            ...
            percentChange: 11.48,
            chartData: [
              16000, 17337, 19220, 18476, 21460, 21558, 16828, 19323, 23561, 20040, 24234, 15204,
            ],
          },
          currentUsage: {
            value: 22875,
            percentChange: -9.75,
            chartData: [
              24297, 17140, 18976, 19252, 21521, 16104, 22891, 23674, 20407, 16816, 23117, 19793,
            ],
          },
          energyBySource: [
            { label: 'Solar Energy', value: 24 },
          ...
          costs: {
            ...
            averageCostPerKWh: { '(WAPDA) - Electricity': 39.8, Generator: 42.25 },
          },
        },
      },
      {
        ...
        day: {
          ...
          costs: {
            totalCost: 14016,
            costBySource: { 'Solar Energy': 0, '(WAPDA) - Electricity': 11115, Generator: 1731 },
        ...
        month: {
          totalConsumption: {
            ...
            percentChange: 3.95,
            chartData: [
              995, 883, 875, 691, 516, 782, 831, 799, 809, 902, 583, 894, 646, 938, 524, 999, 753,
              758, 892, 992, 709, 531, 703, 676, 581, 822, 743, 984, 597, 548,
            ],
          },
          currentUsage: {
            value: 764,
            percentChange: 9.94,
            chartData: [
              730, 627, 643, 636, 713, 622, 696, 692, 747, 795, 659, 784, 744, 620, 754, 606, 600,
              631, 628, 684, 792, 628, 738, 723, 616, 787, 646, 609, 681, 649,
            ],
          },
          energyBySource: [
            { label: 'Solar Energy', value: 20 },
          ...
          costs: {
            totalCost: 231893,
            costBySource: { 'Solar Energy': 0, '(WAPDA) - Electricity': 72406, Generator: 24974 },
        ...
        year: {
          totalConsumption: {
            ...
            percentChange: 12.4,
            chartData: [
              16120, 24223, 24037, 20279, 20621, 19540, 24707, 21075, 24354, 19125, 21248, 23171,
            ],
          },
          currentUsage: {
            value: 20106,
            percentChange: 0.13,
            chartData: [
              24168, 20225, 19193, 17463, 21942, 22835, 18207, 21922, 23989, 23034, 21011, 18815,
            ],
          },
          energyBySource: [
            { label: 'Solar Energy', value: 25 },
          ...
          costs: {
            ...
            averageCostPerKWh: { '(WAPDA) - Electricity': 36.82, Generator: 47.93 },
          },
        },
      },
    ],
...
export default function OverviewAppView() {
  ...
  const [dashboardData, setDashboardData] = useState<any>(
    mockEnergyData[currentTabState]?.aggregated.day
  );
  ...
  useEffect(() => {
    console.log(
      'currentTabState',
      currentTabState,
      mockEnergyData[currentTabState]?.aggregated[currentTab]
    );
    ...
    if (currentClient === 'aggregated') {
      ...
      const client = mockEnergyData[currentTabState]?.clients.find(
        (c: any) => c.id === currentClient
      );
      if (client) {
